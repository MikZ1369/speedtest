package com.mik.speedtest.core.ping
...
abstract class PingStream(private val server: String, private val path: String, pings: Int, errorHandlingMode: String, connectTimeout: Int, soTimeout: Int, recvBuffer: Int, sendBuffer: Int, log: Logger?) {
