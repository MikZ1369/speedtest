package com.mik.speedtest.core.upload
...
abstract class UploadStream(private val server: String, private val path: String, private val ckSize: Int, errorHandlingMode: String, connectTimeout: Int, soTimeout: Int, recvBuffer: Int, sendBuffer: Int, log: Logger?) {
