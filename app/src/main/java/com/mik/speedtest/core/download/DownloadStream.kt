package com.mik.speedtest.core.download

import com.mik.speedtest.core.base.Connection
import com.mik.speedtest.core.base.Utils
import com.mik.speedtest.core.base.Utils.sleep
import com.mik.speedtest.core.config.SpeedtestConfig
import com.mik.speedtest.core.log.Logger

abstract class DownloadStream(private val server: String, private val path: String, private val ckSize: Int, errorHandlingMode: String, connectTimeout: Int, soTimeout: Int, recvBuffer: Int, sendBuffer: Int, log: Logger?) {
